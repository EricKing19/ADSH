...
parser.add_argument ('--lambda-1', default='1', type=str,
                     help='hyper-parameter: oth-lambda-1 (default: 0.001,0.01,0.1,1,10,100)')
parser.add_argument ('--lambda-2', default='1', type=str,
...
if __name__ == "__main__":
    ...
    logdir = '-'.join (['log/run3_194', opt.dataname, datetime.now ().strftime ("%y-%m-%d-%H-%M-%S")])
    _logging ()
    _record ()
