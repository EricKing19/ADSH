...
parser.add_argument ('--dataname', default='imageNet50', type=str,
...
parser.add_argument ('--lambda-2', default='0.04', type=str,
...
def _logging():
    ...
    _format = logging.Formatter ("%(name)-4s: %(levelname)-4s: %(message)")
...
if __name__ == "__main__":
    ...
    logdir = '-'.join (['log/test2', opt.dataname, datetime.now ().strftime ("%y-%m-%d-%H-%M-%S")])
    _logging ()
    _record ()
